...
class SharedResources {
    ...
    // Lock for protecting shared counter variables
    ...
    // Protect context switch counter with a lock
    counterLock.lock();
    try {
        contextSwitchCount++;
    } finally {
    ...
    // Protect completed process counter with a lock
    counterLock.lock();
    try {
    ...
    // Protect total waiting time with a lock
    counterLock.lock();
    try {
